...
logger = logging.getLogger(__name__)
        ...
        #     logger.info(f"Vector index on {self.table_id} created or already exists")
        # except Exception as e:
        #     logger.info(f"Failed to create vector index: {e}")
    ...
    def remove_training_data(self, id: str, **kwargs) -> bool:
        ...
        try:
            ...
            logger.info(f"Failed to remove training data: {e}")
            return False
